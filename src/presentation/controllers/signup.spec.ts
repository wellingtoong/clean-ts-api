...
describe('SignUp Controller', () => {
    ...
    test('Should return 400 it no email is provided', () => {
        const sut = new SignUpController()
        const httpRequest = {
            body: {
                name: 'any_name',
    ...
    test('Should return 400 it no password is provided', () => {
        const sut = new SignUpController()
        const httpRequest = {
            body: {
                name: 'any_name',
    ...
    test('Should return 400 it no password confirmation is provided', () => {
        const sut = new SignUpController()
        const httpRequest = {
            body: {
                name: 'any_name',
