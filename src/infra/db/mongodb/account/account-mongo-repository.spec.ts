...
describe('Account Mongo Repository', () => {
  ...
  describe('loadByToken()', () => {
    test('Should return an account on loadByToken without rule', async () => {
      const sut = makeSut()
      await accountCollection.insertOne({
        name: 'any_name',
        email: 'any_email@mail.com',
    ...
    test('Should return an account on loadByToken with admin rule', async () => {
      const sut = makeSut()
      await accountCollection.insertOne({
        name: 'any_name',
        email: 'any_email@mail.com',
    ...
    test('Should return null on loadByToken with invalid rule', async () => {
      const sut = makeSut()
      await accountCollection.insertOne({
        name: 'any_name',
        email: 'any_email@mail.com',
